...
~~| T3-3 | Autonomy threshold unvalidated — calibrate against real approval patterns | micro | T1-1 (need ledger data) |~~ ✅ done 2026-04-25
...
*(all T4 items from Audit 3.0 shipped 2026-04-23)*
